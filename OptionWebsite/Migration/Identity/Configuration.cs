namespace OptionWebsite.Migration.Identity
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<OptionWebsite.Models.ApplicationDbContext>
    {
        public Configuration()
        {
            AutomaticMigrationsEnabled = false;
            MigrationsDirectory = @"Migration\Identity";
            ContextKey = "OptionWebsite.Models.ApplicationDbContext";
        }

        protected override void Seed(OptionWebsite.Models.ApplicationDbContext context)
        {
